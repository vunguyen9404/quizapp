...
SELECT * FROM dbo.Diem FULL JOIN dbo.MonHoc ON MonHoc.monID = Diem.monID WHERE dotthiID = 'kd24fS8B27XLfmya' AND svID = 'D00001';

SELECT * FROM dbo.SinhVien;
SELECT * FROM dbo.DeThi WHERE dotthiID = 'kd24fS8B27XLfmya';
SELECT * FROM dbo.Diem;
SELECT * FROM dbo.DotThi FULL JOIN dbo.DotThiMon ON DotThiMon.dotthiID = DotThi.dotthiID INNER JOIN dbo.MonHoc ON MonHoc.monID = DotThiMon.monID WHERE DotThi.dotthiID = 'kd24fS8B27XLfmya';